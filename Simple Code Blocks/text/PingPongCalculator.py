## PingPongCalculator.py asks users for their height and weight as input
## in inches and pounds, and converts it into centimeters and kilograms.
## Then, it converts that into the number of Ping-Pong balls they are
## tall and the number of Ping-Pong balls they are in weight.
