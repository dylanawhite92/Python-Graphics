# Color Spiral Input, but now it requests input from the user on
# drawing circular spirals with any number of sides. 
import turtle
t = turtle.Pen()
...
sides = int(t.numinput("Number of sides", 
...
for x in range(100):
    ...
    t.circle(x * 3 / sides + x)    # Change the size to match number of sides
