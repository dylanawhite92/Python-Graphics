...
pygame.display.set_caption("Smiley ExplOSION!!!! Pop those bAD BOYS!!!!!!")
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            if pygame.mouse.get_pressed()[0]:   # Left mouse button, draw
                ...
                if len(clicked_smileys) > 0:    # Pop sound effect on clicked smileys
                    pop.play()
        ...
        draw_string = "Smileys created: " + str(count_smileys)
        draw_string += " - Smileys popped: " + str(count_popped)
